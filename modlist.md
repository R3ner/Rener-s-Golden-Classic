...
This page contains the complete mod list for the pack, grouped by purpose to make it easier to understand what each part of the pack contributes.

The list includes both gameplay/content mods and dependency libraries required by other mods. For a complete installation, use the exact versions listed below.

## ⚙️ Core, Libraries & Mixin Frameworks
> Libraries, APIs, configuration systems and mixin/bootstrap components required by other mods. These are primarily dependency mods rather than content mods.
...
> Performance improvements, bug fixes, rendering optimizations and server/client utilities intended to keep the 1.12.2 experience smoother and more stable.
...
> Mods that expand exploration through new dimensions, world-generation changes, structures, ores and dungeon content.
...
> The main progression and automation layer of the pack, combining magic systems, technology, storage, energy and mechanical utilities.
...
> New creatures, hostile mobs, bosses, companions and other additions that make the world more varied and dangerous.
...
> Weapons, armor, shields, accessories, mobility items and combat-focused mechanics that expand character progression and combat options.
...
> Farming, food, storage, building utilities and decorative blocks designed to make survival, construction and resource management more flexible.
...
> Interface improvements, information overlays, visual and audio enhancements, inventory utilities, maps and other quality-of-life features.
