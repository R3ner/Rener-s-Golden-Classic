<img width="1024" height="247" alt="reners_golde_classic" src="https://github.com/user-attachments/assets/54717686-4f75-4575-b3bd-20357e829562" />
...
4. [Sistemas de Magia y Tecnología](#sistemas-de-magia-y-tecnología)
5. [Dimensiones y Generación de Mundo](#dimensiones-y-generación-de-mundo)
6. [Mobs, Criaturas y Jefes](#mobs-criaturas-y-jefes)
7. [Estructuras, Mazmorras y Botín](#estructuras-mazmorras-y-botín)
8. [Equipamiento, Combate y Mecánicas](#equipamiento-combate-y-mecánicas)
9. [Agricultura, Comida y Construcción](#agricultura-comida-y-construcción)
10. [Utilidades y Audio-Visuales](#utilidades-y-audio-visuales)

---

## Núcleo, Motor y Librerías

Cargadores principales, iniciadores de Mixin y librerías de dependencias esenciales requeridas para la estabilidad del modpack y la compatibilidad entre mods.
...
| **MixinBootstrap** | `_MixinBootstrap-1.1.0.jar` | Librería de inicialización de Mixin |
| **SuperMartijn642's Core Lib** | `_supermartijn642corelib-1.1.22-forge-mc1.12.jar` | Librería de dependencia para los mods de SuperMartijn642 |
| **Atlas Lib** | `Atlas-Lib-1.12.2-1.1.11.jar` | Librería de soporte para renderizado de interfaz y animaciones |
...
| **Nether API** | `Nether-API-v1.4.5-mc1.12.2.jar` | Capa de compatibilidad para biomas del Nether |
| **OreLib** | `OreLib-1.12.2-3.6.0.1.jar` | Librería matemática y de motor de renderizado |
| **Placebo** | `Placebo-1.12.2-1.6.1.jar` | Librería compartida para los mods de Shadows_of_Fire |
| **PTRLib** | `PTRLib-1.0.5.jar` | Framework de procesamiento y renderizado de modelos 3D |
| **RenderLib** | `RenderLib-1.12.2-1.4.5.jar` | Librería auxiliar para optimización del sistema de renderizado |
| **SuperMartijn642's Config Lib** | `supermartijn642configlib-1.1.8-forge-mc1.12.jar` | Lector y gestor de configuraciones |
| **SynLib** | `synlib-4.0.jar` | Librería auxiliar de soporte técnico |
| **XaeroLib** | `xaerolib-forge-1.12.2-1.7.1.jar` | Motor base indispensable para los mapas de Xaero |

---

## Rendimiento y Optimización

Correcciones de rendimiento, optimización de memoria, culling de entidades, procesamiento multihilo y mejoras de FPS.
...
| **Entity Culling** | `entityculling-1.12.2-1.6.3.jar` | Oculta el renderizado de entidades bloqueadas fuera de la vista |
| **ExperienceBugFix** | `ExperienceBugFix-1.12.2-1.0.0.0.jar` | Corrige desincronizaciones y tirones visuales con orbes de experiencia |
| **Farsight** | `farsight-1.6.jar` | Cachiado de chunks en el cliente para mantener altas distancias de renderizado |
| **FastFurnace** | `FastFurnace-1.12.2-1.3.1.jar` | Optimización del procesamiento lógico de los hornos |
| **FastLeafDecay** | `FastLeafDecay-v14.jar` | Acelera la caída de hojas al cortar árboles |
...
## Interfaz de Usuario y Mejoras de Cliente

Actualizaciones visuales del HUD, control de inventario, interfaces de mapas, descripciones e interfaces personalizadas.

| Nombre del Mod | Nombre del Archivo | Categoría / Descripción |
| :--- | :--- | :--- |
| **3D Skin Layers** | `3dSkinLayers-forge-mc1.12.2-1.2.0.jar` | Convierte las capas planas de las skins en modelos tridimensionales |
| **AppleSkin** | `AppleSkin-mc1.12-1.0.14.jar` | Muestra valores precisos de saturación y agotamiento de comida en el HUD |
| **Better Advancements** | `BetterAdvancements-1.12.2-0.1.0.77.jar` | Rediseño a pantalla completa del menú de logros y avances |
...
| **Durability Tooltip** | `durabilitytooltip-1.1.6-forge-mc1.12.jar` | Muestra la durabilidad numérica exacta al pasar el ratón por una herramienta |
...
| **Just Enough Items (JEI)** | `jei_1.12.2-4.16.1.301.jar` | Buscador principal de recetas y lista completa de ítems |
...
| **Nimble** | `Nimble-0.0.2.jar` | Cambia automáticamente a tercera persona al volar con Elytras |
...
Artes mágicas, automatización tecnológica, redes de energía y maquinaria especializada.
...
## Dimensiones y Generación de Mundo

Nuevas dimensiones, biomas expandidos, generación subterránea y terreno variado.

| Nombre del Mod | Nombre del Archivo | Categoría / Descripción |
| :--- | :--- | :--- |
| **The Aether** | `aether-1.12.2-v1.5.4.1.jar` | La mítica dimensión del paraíso en las nubes |
| **Alfheim** | `Alfheim-1.6.jar` | Expansión de dimensión avanzada para el contenido final de Botania |
| **Basic Nether Ores** | `BasicNetherOres-1.12.2-1.0.5.0.jar` | Genera variantes de los minerales tradicionales en el Nether |
| **BetterEnd Forge Unofficial** | `BetterEndForge-Unofficial-GBPort-1.12.2-1.3.9.jar` | Adaptación de los biomas y estructuras modernas de la dimensión del End |
| **Better Nether** | `betternether-0.1.8.6.jar` | Rediseño completo del Nether con flora, plantas y nuevos materiales |
| **Lost Aether Content** | `lost-aether-content-1.12.2-1.0.2.jar` | Recupera elementos y contenido eliminado de The Aether |
| **NetherEx** | `NetherEx-1.12.2-2.2.5.jar` | Expansión con nuevos subbiomas y exploración mejorada en el Nether |
| **Novam Terram** | `NovamTerram-7.3.6.3.jar` | Amplia variedad de nuevos biomas y terreno para el Overworld |
| **Oceanic Expanse** | `OceanicExpanse-1.2.2.jar` | Trae las características de los océanos de las versiones 1.13+ a 1.12.2 |
| **Rare Ice** | `rare-ice-0.1.1.jar` | Variantes raras de hielo en biomas fríos |
| **The Twilight Forest** | `twilightforest-1.12.2-3.11.1021-universal.jar` | Dimensión mística repleta de estructuras, jefes y progresión |
| **Unseen's Nether Backport** | `unseens-nether-backport-0.7.jar` | Adapta bloques y mecánicas de la actualización del Nether 1.16+ |

---

## Mobs, Criaturas y Jefes

Enemigos, bestias mitológicas, fauna pacífica, mascotas y mecánicas de jefes.

| Nombre del Mod | Nombre del Archivo | Categoría / Descripción |
| :--- | :--- | :--- |
| **Beast Slayer** | `beastslayer-not.2.0.03.release.jar` | Añade criaturas fantásticas agresivas y minijefes |
| **Champions** | `champions-1.12.2-1.0.11.10.jar` | Sistema que otorga habilidades especiales y afijos a mobs comunes |
...
## Estructuras, Mazmorras y Botín

Estructuras generadas, mazmorras roguelike, cofres de tesoro y tablas de botín.

| Nombre del Mod | Nombre del Archivo | Categoría / Descripción |
| :--- | :--- | :--- |
| **Battle Towers** | `BattleTower-1.12.2.jar` | Torres de combate con múltiples pisos y un jefe en la cima |
| **Better Strongholds** | `BetterStronghold -0.1.jar` | Reconstrucción arquitectónica completa de las fortalezas del End |
| **Bountiful** | `Bountiful-2.2.2.jar` | Tableros de recompensas en las aldeas con misiones y premios |
| **Doomlike Dungeons** | `dldungeonsjbg-1.14.17-MC1.12.2.jar` | Mazmorras subterráneas procedimentales estilo laberinto |
| **Lootr** | `lootr-1.12.2-0.6.2.jar` | Instancia el botín de los cofres para cada jugador individualmente |
| **Rex's Additional Structures** | `Rex's-AdditionalStructures-1.12.x(v.2.5.0).jar` | Añade pequeñas ruinas y detalles estéticos al mundo |
| **Roguelike Dungeons (Fnar Edition)** | `RoguelikeDungeonsFnarEdition-1.12.2-2.4.6.jar` | Extensas mazmorras subterráneas multinivel |
| **ToroQuest** | `toroquest-1.12.2-5.3.jar` | Reinos de aldeas, reputación y misiones de civilizaciones |
| **Wesley's Roguelike Dungeons** | `Wesley's Roguelike Dungeons V0.8.1.jar` | Gigantescas mazmorras tematizadas llenas de peligros |

---

## Equipamiento, Combate y Mecánicas

Armas, armaduras, accesorios, físicas de combate y ajustes para el jugador.
...
Artes culinarias, agricultura expandida, bloques decorativos y herramientas de construcción.
...
| **Iron Barrels** | `IronBarrels1.12.2-V2.0.jar` | Barriles de almacenamiento de alta capacidad por niveles |
| **Iron Chests** | `ironchest-1.12.2-7.0.72.847.jar` | Cofres metálicos expandibles con mayor capacidad |
| **Iron Core** | `IronCore1.12.2-V1.2.jar` | Librería lógica compartida para cofres y barriles |
| **Iron Furnaces** | `ironfurnaces-1.3.5.jar` | Hornos de alta velocidad fabricados con metales |
| **KleeSlabs** | `KleeSlabs_1.12.2-5.4.12.jar` | Permite romper una sola mitad de una losa doble |
| **Macaw's Bridges** | `mcw-bridges-1.0.6b-mc1.12.2.jar` | Puentes modulares de madera y piedra |
| **Macaw's Doors** | `mcw-doors-1.0.3-mc1.12.2.jar` | Gran variedad de estilos de puertas |
| **Macaw's Fences and Walls** | `mcw-fences-1.0.0-mc1.12.2.jar` | Diseños variados de vallas y muros de contención |
...
## Utilidades y Audio-Visuales

Efectos de sonido ambientales, iluminación dinámica, mejoras de utilidad y compatibilidad con servidores.
...
| **Swap To Garbage (STG)** | `stg-1.12.2-1.2.3.jar` | Reemplaza automáticamente herramientas rotas por una nueva del inventario |
| **Torchmaster** | `torchmaster_1.12.2-1.8.5.0.jar` | Mega antorchas para evitar la aparición de mobs en áreas grandes |
| **TrashSlot** | `TrashSlot_1.12.2-8.4.10.jar` | Casilla de papelera integrada para eliminar objetos del inventario |
| **Two Players One Horse** | `twoplayersonehorse-1.12.2-1.0.3.jar` | Permite que dos jugadores monten simultáneamente en el mismo caballo |
| **Waystones** | `Waystones_1.12.2-4.1.0.jar` | Monolitos de teletransporte y viaje rápido entre puntos |
| **WTS (What's That Song)** | `WTS-1.1.0.jar` | Muestra en pantalla el título de la canción que está sonando |
| **YARCF** | `YARCF-0.14(1.12.2).jar` | Herramienta para resolver conflictos de recetas cruzadas |
